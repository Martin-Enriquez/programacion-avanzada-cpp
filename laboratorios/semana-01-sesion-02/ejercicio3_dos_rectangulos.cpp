...
/*El error está en la línea 41 y 42 respectivamente. Se está pasando como argumento
 la altura del rect1 a la "funcion" que corresponde al rect2*/
//
//
...
void imprimirConObjetos() {
    ...
    /*rect1.area(),rect1.perimetro();
    rect2.area(),rect2.perimetro();*/

    std::cout << "RECTANGULO 1, Area " << rect1.area() <<", Perimetro "
    <<rect1.perimetro() << std::endl;

    std::cout << "RECTANGULO 2, Area " << rect2.area() <<", Perimetro "<<
    rect2.perimetro() << std::endl;
